...
def SegFormer_B0(image_size,num_classes):
    model = MixVisionTransformer(img_size=image_size, patch_size=4, in_chans=3, num_classes=num_classes, embed_dims=[32, 64, 160, 256],
                                 decoder_embedding_dim=256, num_heads=[1, 2, 5, 8], 
...
def SegFormer_B1(image_size,num_classes):
...
def SegFormer_B2(image_size,num_classes):
    model = MixVisionTransformer(img_size=image_size, patch_size=4, in_chans=3, num_classes=num_classes, embed_dims=[64, 128, 320, 512],
                                 decoder_embedding_dim=256, num_heads=[1, 2, 5, 8], 
                                 mlp_ratios=[4, 4, 4, 4],qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), 
...
def SegFormer_B3(image_size,num_classes):
    model = MixVisionTransformer(img_size=image_size, patch_size=4, in_chans=3, num_classes=num_classes, embed_dims=[64, 128, 320, 512],
